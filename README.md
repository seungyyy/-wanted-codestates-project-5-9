...
<img width="500" src="https://user-images.githubusercontent.com/54584337/160150907-939129c5-5cec-4f15-8c3f-425f4ee9b13f.gif" alt="gif">
<img width="500" src="https://user-images.githubusercontent.com/54584337/160153211-faa2ba10-46cf-49aa-8870-f76a9f2f2a52.gif" alt="gif">
...
## 상품 리뷰 상세 페이지 
<img width="500" src="https://user-images.githubusercontent.com/54584337/160154690-c0b5c3d6-be66-4d9c-a1d6-eaeb71fc20cf.gif" alt="gif">
<img width="500" src="https://user-images.githubusercontent.com/54584337/160155955-0c62232a-0dc7-42ed-9c73-597858006b8f.gif" alt="gif">
...
<img width="500" src="https://user-images.githubusercontent.com/54584337/160156158-203b8646-ec61-4252-9328-912ac80b5f0e.png" alt="img">
<img width="500" src="https://user-images.githubusercontent.com/54584337/160156396-256443d6-f3f0-4846-a11f-6df85c0cec94.gif" alt="gif">

- 리뷰 제목, 이미지 선택 , 평점(별점 5점 만점) 등록이 되는 페이지입니다. 제목, 내용, 사진 입력이 없을시 저장이 되지 않습니다 사진 선택후 맘에 들지 않을 경우 삭제하고 다시 선택할 수 있습니다.
- 리뷰를 등록 시 데이터에 저장이 됩니다.


### 개발 중 어려웠던 점 && 해결
- 리덕스를 사용해서 데이터를 정렬할때 처음에 헤매는 시간이 있었지만 잘 해결하였습니다. 
- 리뷰등록 후 데이터 오류가 발생하는 문제가 있었고  새로운 Object를 생성해, 기존의 state의 값을 먼저 복사해 Object에 할당한 뒤 원래 데이터와 action에 담긴 data를 합친 새로운 배열을 생성하여 데이터를 저장하였습니다.
